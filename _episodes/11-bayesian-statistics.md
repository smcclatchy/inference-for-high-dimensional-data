...
# Instead, please edit 11-bayesian-statistics.md in _episodes_rmd/
source: Rmd
...
![Simulation demonstrating Bayes theorem. Top plot shows every individual with red denoting cases. Each one takes a test and with 90% gives correct answer. Those called positive (either correctly or incorrectly) are put in the bottom left pane. Those called negative in the bottom right.](figure/simulation-1.png)
...
![Batting average histograms for 2010, 2011, and 2012.](figure/batting_averages-1.png)
